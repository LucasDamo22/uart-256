...
add wave -noupdate -expand -group ram -radix unsigned -childformat {{{/tb/DUT/mem/RAM[0]} -radix unsigned} {{/tb/DUT/mem/RAM[1]} -radix unsigned} {{/tb/DUT/mem/RAM[2]} -radix unsigned} {{/tb/DUT/mem/RAM[3]} -radix unsigned} {{/tb/DUT/mem/RAM[4]} -radix unsigned} {{/tb/DUT/mem/RAM[5]} -radix unsigned} {{/tb/DUT/mem/RAM[6]} -radix unsigned} {{/tb/DUT/mem/RAM[7]} -radix unsigned} {{/tb/DUT/mem/RAM[8]} -radix unsigned} {{/tb/DUT/mem/RAM[9]} -radix unsigned} {{/tb/DUT/mem/RAM[10]} -radix unsigned}} -subitemconfig {{/tb/DUT/mem/RAM[0]} {-height 16 -radix unsigned} {/tb/DUT/mem/RAM[1]} {-height 16 -radix unsigned} {/tb/DUT/mem/RAM[2]} {-height 16 -radix unsigned} {/tb/DUT/mem/RAM[3]} {-height 16 -radix unsigned} {/tb/DUT/mem/RAM[4]} {-height 16 -radix unsigned} {/tb/DUT/mem/RAM[5]} {-height 16 -radix unsigned} {/tb/DUT/mem/RAM[6]} {-height 16 -radix unsigned} {/tb/DUT/mem/RAM[7]} {-height 16 -radix unsigned} {/tb/DUT/mem/RAM[8]} {-height 16 -radix unsigned} {/tb/DUT/mem/RAM[9]} {-height 16 -radix unsigned} {/tb/DUT/mem/RAM[10]} {-height 16 -radix unsigned}} /tb/DUT/mem/RAM
add wave -noupdate -expand -group tb_data -radix unsigned -childformat {{{/tb/serial_data[7]} -radix unsigned -childformat {{{/tb/serial_data[7][10]} -radix unsigned} {{/tb/serial_data[7][9]} -radix unsigned} {{/tb/serial_data[7][8]} -radix unsigned} {{/tb/serial_data[7][7]} -radix unsigned} {{/tb/serial_data[7][6]} -radix unsigned} {{/tb/serial_data[7][5]} -radix unsigned} {{/tb/serial_data[7][4]} -radix unsigned} {{/tb/serial_data[7][3]} -radix unsigned} {{/tb/serial_data[7][2]} -radix unsigned} {{/tb/serial_data[7][1]} -radix unsigned} {{/tb/serial_data[7][0]} -radix unsigned}}} {{/tb/serial_data[6]} -radix unsigned} {{/tb/serial_data[5]} -radix unsigned} {{/tb/serial_data[4]} -radix unsigned} {{/tb/serial_data[3]} -radix unsigned} {{/tb/serial_data[2]} -radix unsigned} {{/tb/serial_data[1]} -radix unsigned} {{/tb/serial_data[0]} -radix unsigned -childformat {{{/tb/serial_data[0][10]} -radix unsigned} {{/tb/serial_data[0][9]} -radix unsigned} {{/tb/serial_data[0][8]} -radix unsigned} {{/tb/serial_data[0][7]} -radix unsigned} {{/tb/serial_data[0][6]} -radix unsigned} {{/tb/serial_data[0][5]} -radix unsigned} {{/tb/serial_data[0][4]} -radix unsigned} {{/tb/serial_data[0][3]} -radix unsigned} {{/tb/serial_data[0][2]} -radix unsigned} {{/tb/serial_data[0][1]} -radix unsigned} {{/tb/serial_data[0][0]} -radix unsigned}}}} -expand -subitemconfig {{/tb/serial_data[7]} {-height 16 -radix unsigned -childformat {{{/tb/serial_data[7][10]} -radix unsigned} {{/tb/serial_data[7][9]} -radix unsigned} {{/tb/serial_data[7][8]} -radix unsigned} {{/tb/serial_data[7][7]} -radix unsigned} {{/tb/serial_data[7][6]} -radix unsigned} {{/tb/serial_data[7][5]} -radix unsigned} {{/tb/serial_data[7][4]} -radix unsigned} {{/tb/serial_data[7][3]} -radix unsigned} {{/tb/serial_data[7][2]} -radix unsigned} {{/tb/serial_data[7][1]} -radix unsigned} {{/tb/serial_data[7][0]} -radix unsigned}}} {/tb/serial_data[7][10]} {-radix unsigned} {/tb/serial_data[7][9]} {-radix unsigned} {/tb/serial_data[7][8]} {-radix unsigned} {/tb/serial_data[7][7]} {-height 16 -radix unsigned} {/tb/serial_data[7][6]} {-height 16 -radix unsigned} {/tb/serial_data[7][5]} {-height 16 -radix unsigned} {/tb/serial_data[7][4]} {-height 16 -radix unsigned} {/tb/serial_data[7][3]} {-height 16 -radix unsigned} {/tb/serial_data[7][2]} {-height 16 -radix unsigned} {/tb/serial_data[7][1]} {-height 16 -radix unsigned} {/tb/serial_data[7][0]} {-height 16 -radix unsigned} {/tb/serial_data[6]} {-height 16 -radix unsigned} {/tb/serial_data[5]} {-height 16 -radix unsigned} {/tb/serial_data[4]} {-height 16 -radix unsigned} {/tb/serial_data[3]} {-height 16 -radix unsigned} {/tb/serial_data[2]} {-height 16 -radix unsigned} {/tb/serial_data[1]} {-height 16 -radix unsigned} {/tb/serial_data[0]} {-height 16 -radix unsigned -childformat {{{/tb/serial_data[0][10]} -radix unsigned} {{/tb/serial_data[0][9]} -radix unsigned} {{/tb/serial_data[0][8]} -radix unsigned} {{/tb/serial_data[0][7]} -radix unsigned} {{/tb/serial_data[0][6]} -radix unsigned} {{/tb/serial_data[0][5]} -radix unsigned} {{/tb/serial_data[0][4]} -radix unsigned} {{/tb/serial_data[0][3]} -radix unsigned} {{/tb/serial_data[0][2]} -radix unsigned} {{/tb/serial_data[0][1]} -radix unsigned} {{/tb/serial_data[0][0]} -radix unsigned}}} {/tb/serial_data[0][10]} {-radix unsigned} {/tb/serial_data[0][9]} {-radix unsigned} {/tb/serial_data[0][8]} {-radix unsigned} {/tb/serial_data[0][7]} {-height 16 -radix unsigned} {/tb/serial_data[0][6]} {-height 16 -radix unsigned} {/tb/serial_data[0][5]} {-height 16 -radix unsigned} {/tb/serial_data[0][4]} {-height 16 -radix unsigned} {/tb/serial_data[0][3]} {-height 16 -radix unsigned} {/tb/serial_data[0][2]} {-height 16 -radix unsigned} {/tb/serial_data[0][1]} {-height 16 -radix unsigned} {/tb/serial_data[0][0]} {-height 16 -radix unsigned}} /tb/serial_data
add wave -noupdate /tb/sig_rts_rx
add wave -noupdate /tb/cont
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {919637021 ps} 0}
...
update
WaveRestoreZoom {755535055 ps} {2392527675 ps}
