...
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVDS     } [get_ports { clock_n }]; #IO_L13N_T2_MRCC_38 Sch=fpga_sysclk_n
set_property -dict { PACKAGE_PIN H19   IOSTANDARD LVDS     } [get_ports { clock_p }]; #IO_L13P_T2_MRCC_38 Sch=fpga_sysclk_p
create_clock -add -name sys_clk_pin -period 5.00 -waveform {0 2.5} [get_ports {clock_p}]; 
...
##BTN
set_property -dict { PACKAGE_PIN AR13  IOSTANDARD LVCMOS15 } [get_ports { reset }]; #IO_L12N_T1_MRCC_31 Sch=btn[0]
#set_property -dict { PACKAGE_PIN BB12  IOSTANDARD LVCMOS15 } [get_ports { BTN[1] }]; #IO_L24N_T3_31 Sch=btn[1]

##LED
set_property -dict { PACKAGE_PIN AR22  IOSTANDARD LVCMOS15 } [get_ports { states_led[0] }]; #IO_L11N_T1_SRCC_33 Sch=led[0]
set_property -dict { PACKAGE_PIN AR23  IOSTANDARD LVCMOS15 } [get_ports { states_led[1] }]; #IO_L11P_T1_SRCC_33 Sch=led[1]
...
set_property -dict { PACKAGE_PIN BA19  IOSTANDARD LVCMOS15 } [get_ports { sig_tx }]; #IO_L24N_T3_32 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN AY19  IOSTANDARD LVCMOS15 } [get_ports { sig_rx }]; #IO_L24P_T3_32 Sch=uart_txd_in
